...
class GreedyParser(object):
  ...
  operations needed to train_bkp the network on the other. Supports multiple
  network instantiations sharing the same parameters and network topology.

  The following named nodes are added to the training and eval_bkp networks:
  ...
  def __init__(self,
    ...
    Args:
      ...
      only_train: the comma separated set of parameter names to train_bkp. If empty,
    ...
    self.inits = {}
    # Training- and eval_bkp-related nodes.
    self.training = {}
    self.evaluation = {}
    self.saver = None
    # Nodes to compute moving averages of parameters, called every train_bkp step.
    self._averaging = {}
  ...
  def _AddParam(self,
    ...
    if name not in self.params:
      ...
      # irrespective of the current scope (training or eval_bkp).
  ...
  def AddEvaluation(self,
    ...
    Returns:
      Dictionary of named eval_bkp nodes.
    """
