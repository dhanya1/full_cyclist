...
To easily train_bkp a model on multiple GPUs or across multiple machines this
...
Usage:
  ...
  with tf.device(config.optimizer_device()):
    optimizer = tf.train_bkp.MomentumOptimizer(FLAGS.learning_rate, FLAGS.momentum)
  ...
  # Run training.
  slim.learning.train_bkp(model_dp.train_op, my_log_dir,
...
DeployedModel namedtuple, holds together the values needed to train_bkp multiple
clones:
