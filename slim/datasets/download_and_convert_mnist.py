...
that make up the MNIST data and creates two TFRecord datasets: one for train_bkp
...
_TRAIN_DATA_FILENAME = 'train_bkp-images-idx3-ubyte.gz'
_TRAIN_LABELS_FILENAME = 'train_bkp-labels-idx1-ubyte.gz'
...
def run(dataset_dir):
  ...
  training_filename = _get_output_filename(dataset_dir, 'train_bkp')
