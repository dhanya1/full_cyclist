...
flags.DEFINE_string('eval_dir', '', 'Directory for writing eval_bkp event logs')
...
def metrics(logits, labels):
  """Specify the metrics for eval_bkp.
  ...
  for name, value in names_to_values.iteritems():
    slim.summaries.add_scalar_summary(
        value, name, prefix='eval_bkp', print_summary=True)
...
def build_model():
  ...
  Returns:
    ...
    folding.
    eval_ops: eval_bkp ops for inference.
