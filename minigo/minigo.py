...
One iteration of RL learning consists of bootstrap, selfplay, gather and train_bkp:
  ...
  train_bkp: Train a new model with the selfplay results from the most recent
    N generations.
...
def main(_):
  ...
  for rl_iter in range(params.max_iters_per_pipeline):
    ...
    # train_bkp the next generation model
