...
tf.app.flags.DEFINE_integer("eval_beam_steps", 4, "How many beam steps eval_bkp.")
...
tf.app.flags.DEFINE_integer("eval_bin_print", 3, "How many bins step in eval_bkp.")
tf.app.flags.DEFINE_integer("mode", 0, "Mode: 0-train_bkp other-decode.")
...
def train():
  ...
  with sess.as_default():
    ...
    while not sv.ShouldStop():
      ...
      msg = ("step %d step-time %.2f train_bkp-size %.3f lr %.6f grad-norm %.4f"
