...
tf.app.flags.DEFINE_string('train_dir', '', 'Directory for train_bkp.')
tf.app.flags.DEFINE_string('eval_dir', '', 'Directory for eval_bkp.')
tf.app.flags.DEFINE_string('decode_dir', '', 'Directory for decode summaries.')
tf.app.flags.DEFINE_string('mode', 'train_bkp', 'train_bkp/eval_bkp/decode mode')
...
tf.app.flags.DEFINE_integer('eval_interval_secs', 60, 'How often to run eval_bkp.')
...
def _Eval(model, data_batcher, vocab=None):
  ...
  while True:
    ...
    if not (ckpt_state and ckpt_state.model_checkpoint_path):
      tf.logging.info('No model to eval_bkp yet at %s', FLAGS.train_dir)
      continue
...
def main(unused_argv):
  ...
  hps = seq2seq_attention_model.HParams(
      mode=FLAGS.mode,  # train_bkp, eval_bkp, decode
