...
flags.DEFINE_integer('patch_size', 32, 'The size of the patches to train_bkp on.')
  ...
  with tf.device(tf.train.replica_device_setter(FLAGS.ps_tasks)):
    ...
    with tf.device('/cpu:0'), tf.name_scope('inputs'):
      real_images = data_provider.provide_data(
          'train_bkp', FLAGS.batch_size, dataset_dir=FLAGS.dataset_dir,
    ...
    # Use GAN train_bkp step function if using adversarial loss, otherwise
    # only train_bkp the generator.
