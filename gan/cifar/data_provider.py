...
def provide_data(batch_size, dataset_dir, dataset_name='cifar10',
                 split_name='train_bkp', one_hot=True):
  ...
  Args:
    ...
    split_name: Should be either 'train_bkp' or 'test'.
  ...
  Raises:
    ValueError: if the split_name is not either 'train_bkp' or 'test'.
  """
