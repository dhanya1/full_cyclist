...
_SPLITS_TO_SIZES = {'train_bkp': 58001, 'valid': 1000, 'test': 9001}
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
  ...
  Args:
    split_name: A train_bkp/test split name.
  ...
  Raises:
    ValueError: if `split_name` is not a valid train_bkp/test split.
  """
