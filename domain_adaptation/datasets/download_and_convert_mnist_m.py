...
that make up the MNIST-M data and creates two TFRecord datasets: one for train_bkp
...
def _convert_dataset(split_name, filenames, filename_to_class_id, dataset_dir):
  ...
  Args:
    split_name: The name of the dataset, either 'train_bkp' or 'valid'.
  ...
  # Train and validation splits are both in the train_bkp directory.
  if split_name in ['train_bkp', 'valid']:
...
def _get_output_filename(dataset_dir, split_name):
  ...
  Args:
    ...
    split_name: The name of the train_bkp/test split.
...
def run(dataset_dir):
  ...
  train_filename = _get_output_filename(dataset_dir, 'train_bkp')
  ...
  # Divide into train_bkp and validation:
  ...
  # Convert the train_bkp, validation, and test sets.
  _convert_dataset('train_bkp', train_filenames,
