...
def create_model(source_images, source_labels, domain_selection_mask,
  ...
  # Plot target accuracy of the train_bkp set.
  ...
  if 'quaternions' in target_labels:
    target_quaternion_loss = losses.log_quaternion_loss(
        ...
        params)
    tf.summary.scalar('eval_bkp/Target quaternions', target_quaternion_loss)

  tf.summary.scalar('eval_bkp/Target accuracy', target_accuracy)
