...
def _get_files(data, dataset_split):
  ...
  Args:
    ...
    dataset_split: String, dataset split ('train_bkp', 'val', 'test')
...
def _convert_dataset(dataset_split):
  ...
  Args:
    dataset_split: The dataset split (e.g., train_bkp, val).
...
def main(unused_argv):
  # Only support converting 'train_bkp' and 'val' sets for now.
  for dataset_split in ['train_bkp', 'val']:
