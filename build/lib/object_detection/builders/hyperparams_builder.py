...
def build(hyperparams_config, is_training):
  ...
  and conv_hyperparams_config.batch_norm.train_bkp parameter. During training, they
  are updated only if batch_norm.train_bkp parameter is true. However, during eval_bkp,
