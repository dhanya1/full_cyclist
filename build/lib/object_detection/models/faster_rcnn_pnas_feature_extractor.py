...
def pnasnet_large_arg_scope_for_detection(is_batch_norm_training=False):
  ...
  Args:
    is_batch_norm_training: Boolean indicating whether to train_bkp with batch norm.
...
class FasterRCNNPNASFeatureExtractor(
  ...
  def _extract_box_classifier_features(self, proposal_feature_maps, scope):
    ...
    # For now the schedule is the default (1.0->0.7 over 250,000 train_bkp steps).
