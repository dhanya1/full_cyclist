...
flags.DEFINE_integer('worker_replicas', 1, 'Number of worker replicas (train_bkp tasks).')
...
def main(_):
  train_dir = os.path.join(FLAGS.checkpoint_dir, FLAGS.model_name, 'train_bkp')
