...
# General flags.
tf.flags.DEFINE_string('mode', 'eval_bkp',
                       'One of [sample, eval_bkp, dump_emb, dump_lstm_emb]. '
                       '"sample" mode samples future word predictions, using '
                       'FLAGS.prefix as prefix (prefix could be left empty). '
                       '"eval_bkp" mode calculates perplexity of the '
                       'FLAGS.input_data. '
...
tf.flags.DEFINE_string('input_data', '',
                       'Input data files for eval_bkp model.')
tf.flags.DEFINE_integer('max_eval_steps', 1000000,
                        'Maximum mumber of steps to run "eval_bkp" mode.')
