...
# ==============================================================================
"""A library to train_bkp Inception using multiple replicas with synchronous update.
...
tf.app.flags.DEFINE_string('subset', 'train_bkp', 'Either "train_bkp" or "validation".')
