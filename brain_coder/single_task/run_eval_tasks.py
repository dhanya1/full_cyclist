...
r"""This script can launch any eval_bkp experiments from the paper.
...
--training_replicas R specifies that R workers will be launched to train_bkp one
...
def parse_args(extra_args=()):
  ...
  parser = argparse.ArgumentParser(description='Run all eval_bkp tasks.')
  ...
  if args.tasks:
    ...
    print('Running eval_bkp tasks from ICLR paper.')
