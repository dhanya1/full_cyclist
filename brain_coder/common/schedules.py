...
class Schedule(object):
  ...
  counting how many calls to the train_bkp op have been made) to the hparam value.
  ...
  def __call__(self, global_step):
    ...
    `global_step` is an integer counting how many calls to the train_bkp op have
