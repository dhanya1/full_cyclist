...
"""Define flags are common for both train_bkp.py and eval_bkp.py scripts."""
import sys
...
def define():
  ...
  flags.DEFINE_string('train_log_dir', '/tmp/attention_ocr/train_bkp',
                      'Directory where to write event logs.')

  flags.DEFINE_string('dataset_name', 'fsns',
                      'Name of the dataset. Supported: fsns')

  flags.DEFINE_string('split_name', 'train_bkp',
                      'Dataset split name to run evaluation for: test,train_bkp.')
