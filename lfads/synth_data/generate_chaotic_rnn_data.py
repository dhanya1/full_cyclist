...
flags.DEFINE_float("train_percentage", 4.0/5.0,
                   "Percentage of train_bkp vs validation trials")
...
for n in range(ndatasets):
  ...
  if FLAGS.noise_type == "poisson":
    ...
    # split into train_bkp and validation sets
  train_inds, valid_inds = get_train_n_valid_inds(E, train_percentage,
                                                  nreplications)

  # Split the data, inputs, labels and times into train_bkp vs. validation.
