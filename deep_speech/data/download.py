...
LIBRI_SPEECH_URLS = {
    "train_bkp-clean-100":
        "http://www.openslr.org/resources/12/train_bkp-clean-100.tar.gz",
    "train_bkp-clean-360":
        "http://www.openslr.org/resources/12/train_bkp-clean-360.tar.gz",
    "train_bkp-other-500":
        "http://www.openslr.org/resources/12/train_bkp-other-500.tar.gz",
    "dev-clean":
...
def main(_):
  ...
  if FLAGS.train_only:
    download_and_process_datasets(
        FLAGS.data_dir,
        ["train_bkp-clean-100", "train_bkp-clean-360", "train_bkp-other-500"])
  elif FLAGS.dev_only:
