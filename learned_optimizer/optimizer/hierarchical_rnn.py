...
class HierarchicalRNN(opt.TrainableOptimizer):
  ...
  def __init__(self, level_sizes, init_lr_range=(1e-6, 1e-2),
    ...
    Args:
      ...
      dynamic_output_scale: whether to learn weights that dynamically modulate
          the output scale
      use_attention: whether to use attention to train_bkp the optimizer
      use_log_objective: whether to train_bkp on the log of the objective
      ...
      max_log_lr: the maximum log learning rate allowed during train_bkp or test
  ...
  def apply_gradients(self, grads_and_vars, global_step=None, name=None):
    """Overwrites the tf.train_bkp.Optimizer interface for applying gradients."""
