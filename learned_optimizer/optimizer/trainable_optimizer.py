...
class TrainableOptimizer(tf.train.Optimizer):
  ...
  def _apply_common(self, grad, var):
    ...
    During meta-training, the optimizer.train_bkp function should be used to
  ...
  def train(self, problem, dataset):
    """Creates graph operations to train_bkp the optimizer.

    Args:
      problem: A problem_generator.Problem instance to train_bkp on.
