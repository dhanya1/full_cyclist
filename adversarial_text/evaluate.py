...
def _log_values(sess, value_ops, summary_writer=None):
  """Evaluate, log, and write summaries of the eval_bkp metrics in value_ops."""
  ...
  if summary_writer is not None:
    ...
    tf.logging.info('Finished eval_bkp for step ' + str(global_step_val))
...
def main(_):
  ...
  tf.logging.info('Building eval_bkp graph...')
