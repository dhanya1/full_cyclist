...
def _filenames_for_data_spec(phase, bidir, pretrain, use_seq2seq):
  ...
  Args:
    phase: str, 'train_bkp', 'test', or 'valid'.
  ...
  data_specs = {
      ('train_bkp', True, True, False): (data_utils.TRAIN_LM,
                                     data_utils.TRAIN_REV_LM),
      ('train_bkp', True, False, False): (data_utils.TRAIN_BD_CLASS,),
      ('train_bkp', False, True, False): (data_utils.TRAIN_LM,),
      ('train_bkp', False, True, True): (data_utils.TRAIN_SA,),
      ('train_bkp', False, False, False): (data_utils.TRAIN_CLASS,),
...
def inputs(data_dir=None,
  ...
  Args:
    data_dir: str, directory containing TFRecord files of SequenceExample.
    phase: str, dataset for evaluation {'train_bkp', 'valid', 'test'}.
