...
class VatxtModel(object):
  ...
  def classifier_graph(self):
    ...
    * Caches tensors: `cl_embedded`, `cl_logits`, `cl_loss`
    ...
    Returns:
      loss: scalar float.
    """
    inputs = _inputs('train_bkp', pretrain=False)
  ...
  def language_model_graph(self, compute_loss=True):
    ...
    * Caches tensors: `lm_embedded`
    ...
    Returns:
      loss: scalar float.
    """
    inputs = _inputs('train_bkp', pretrain=True)
  ...
  def eval_graph(self, dataset='test'):
    ...
    Args:
      dataset: the labeled dataset to evaluate, {'train_bkp', 'test', 'valid'}.
...
class VatxtBidirModel(VatxtModel):
  ...
  def classifier_graph(self):
    ...
    * Caches tensors: `cl_embedded` (tuple of forward and reverse), `cl_logits`,
    ...
    Returns:
      loss: scalar float.
    """
    inputs = _inputs('train_bkp', pretrain=False, bidir=True)
    self.cl_inputs = inputs
    f_inputs, _ = inputs
  ...
  def language_model_graph(self, compute_loss=True):
    ...
    * Caches tensors: `lm_embedded`, `lm_embedded_reverse`
    ...
    """
    inputs = _inputs('train_bkp', pretrain=True, bidir=True)
    self.lm_inputs = inputs
...
def _inputs(dataset='train_bkp', pretrain=False, bidir=False):
